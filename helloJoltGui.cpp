...
static void init(void) {
    ...
    state.pip_fill = sg_make_pipeline(&_fill_pipeline_desc);
    ...
    state.pip_lines = sg_make_pipeline(&_line_pipeline_desc);
...
static void frame(void) {
    ...
    _sg_bindings.vertex_buffers[0] = state.vbuf;
    _sg_bindings.index_buffer = state.ibuf;
