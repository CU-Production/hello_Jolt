...
static void create_physics_scene() {
	...
	// ragdoll
    {
    	...
    	state.physics.ragdoll.ragdoll = settings->CreateRagdoll(0, 0, &state.physics.physics_system);
...
static void clear_physics_scene() {
	...
	state.physics.ragdoll.ragdoll->RemoveFromPhysicsSystem();
	state.physics.ragdoll.ragdoll = nullptr;
